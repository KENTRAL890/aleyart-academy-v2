...
export const NACCA_DIAGRAMS: Record<string, { label: string; url: string; topic: string }[]> = {
  ...
  'Social Studies': [
    ...
    { label: 'Government Structure of Ghana', url: 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 180"><rect x="100" y="10" width="100" height="35" fill="#bfdbfe" stroke="#1d4ed8" stroke-width="2" rx="4"/><text x="150" y="32" font-size="10" font-weight="bold" text-anchor="middle">PRESIDENT</text><line x1="150" y1="45" x2="150" y2="65" stroke="#1d4ed8" stroke-width="2"/><line x1="50" y1="65" x2="250" y2="65" stroke="#1d4ed8" stroke-width="2"/><rect x="10" y="70" width="80" height="30" fill="#dcfce7" stroke="#166534" stroke-width="2" rx="4"/><text x="50" y="88" font-size="8" font-weight="bold" text-anchor="middle">EXECUTIVE</text><rect x="110" y="70" width="80" height="30" fill="#fef3c7" stroke="#854d0e" stroke-width="2" rx="4"/><text x="150" y="88" font-size="8" font-weight="bold" text-anchor="middle">LEGISLATURE</text><rect x="210" y="70" width="80" height="30" fill="#fce7f3" stroke="#be185d" stroke-width="2" rx="4"/><text x="250" y="88" font-size="8" font-weight="bold" text-anchor="middle">JUDICIARY</text><line x1="50" y1="65" x2="50" y2="70" stroke="#1d4ed8" stroke-width="2"/><line x1="150" y1="65" x2="150" y2="70" stroke="#1d4ed8" stroke-width="2"/><line x1="250" y1="65" x2="250" y2="70" stroke="#1d4ed8" stroke-width="2"/></svg>'), topic: 'Government / Governance' },
  ],
  'RME': [
  ...
  'English Language': [
    { label: 'Letter Writing Format (Formal)', url: 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 300"><rect x="10" y="10" width="240" height="280" fill="#f8fafc" stroke="#334155" stroke-width="2" rx="4"/><text x="200" y="35" font-size="9" text-anchor="end">Sender Address</text><text x="200" y="50" font-size="9" text-anchor="end">Date</text><text x="30" y="80" font-size="9">Receiver Address</text><text x="30" y="110" font-size="9" font-weight="bold">Dear Sir/Madam,</text><text x="30" y="130" font-size="9" font-weight="bold" text-decoration="underline">TITLE</text><text x="30" y="155" font-size="8" fill="#64748b">Body paragraph 1...</text><text x="30" y="175" font-size="8" fill="#64748b">Body paragraph 2...</text><text x="30" y="210" font-size="9">Yours faithfully,</text><text x="30" y="230" font-size="9">Signature</text><text x="30" y="250" font-size="9">Name</text></svg>'), topic: 'Letter Writing / Composition' },
  ],
  'French': [
    { label: 'French Greetings Chart', url: 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 200"><rect x="10" y="10" width="260" height="180" fill="#eff6ff" stroke="#2563eb" stroke-width="2" rx="6"/><text x="140" y="35" font-size="14" font-weight="bold" text-anchor="middle" fill="#1d4ed8">Les Salutations</text><text x="40" y="65" font-size="11" font-weight="bold">Bonjour</text><text x="170" y="65" font-size="10" fill="#64748b">Good morning</text><text x="40" y="90" font-size="11" font-weight="bold">Bonsoir</text><text x="170" y="90" font-size="10" fill="#64748b">Good evening</text><text x="40" y="115" font-size="11" font-weight="bold">Merci</text><text x="170" y="115" font-size="10" fill="#64748b">Thank you</text><text x="40" y="140" font-size="11" font-weight="bold">Au revoir</text><text x="170" y="140" font-size="10" fill="#64748b">Goodbye</text><text x="40" y="165" font-size="11" font-weight="bold">S il vous plaît</text><text x="170" y="165" font-size="10" fill="#64748b">Please</text></svg>'), topic: 'Greetings / Vocabulary' },
  ],
  'History': [
    { label: 'Timeline: Ghana Independence', url: 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 120"><line x1="20" y1="60" x2="300" y2="60" stroke="#1e293b" stroke-width="3"/><circle cx="60" cy="60" r="8" fill="#ef4444"/><text x="60" y="45" font-size="9" text-anchor="middle" font-weight="bold">1844</text><text x="60" y="85" font-size="7" text-anchor="middle">Bond of 1844</text><circle cx="140" cy="60" r="8" fill="#eab308"/><text x="140" y="45" font-size="9" text-anchor="middle" font-weight="bold">1874</text><text x="140" y="85" font-size="7" text-anchor="middle">Gold Coast Colony</text><circle cx="220" cy="60" r="8" fill="#22c55e"/><text x="220" y="45" font-size="9" text-anchor="middle" font-weight="bold">1957</text><text x="220" y="85" font-size="7" text-anchor="middle">Independence</text><circle cx="280" cy="60" r="8" fill="#3b82f6"/><text x="280" y="45" font-size="9" text-anchor="middle" font-weight="bold">1960</text><text x="280" y="85" font-size="7" text-anchor="middle">Republic</text></svg>'), topic: 'Independence / Nationalism' },
  ],
};
